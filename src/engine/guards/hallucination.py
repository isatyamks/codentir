...
class HallucinationGuard:
    ...
    def check_grounding(
        ...
        grounding_ratio = (
            grounded_count / total_statements if total_statements > 0 else 1.0
        )
    ...
    def _is_statement_grounded(self, statement: str, context: str) -> bool:
        ...
        statement_words = {
            w for w in statement_words if len(w) > 2 and w not in common_words
        }
    ...
    def validate_output(
        self, output: str, context: List[Dict[str, Any]], raise_error: bool = False
    ) -> bool:
    ...
    def get_hallucination_report(self, check_result: Dict[str, Any]) -> str:
